...
while running:
    ...
    exit_button = pygame.Rect(300, 260, 200, 50)
    draw_text('Максимально убийств: ' + str(max_kill_count), font, black, screen, 250, 150)
    draw_text('Играть', font, black, screen, 325, 210)
    draw_text('Выйти', font, black, screen, 325, 270)
